-- 39_fix_submit_quiz_status.sql

-- ==========================================
-- Fix RPC to correctly set status for manual grading
-- ==========================================
-- If any question in the quiz requires manual grading (needs_grading = true),
-- the quiz result status should be 'pending_grading' instead of 'completed'.

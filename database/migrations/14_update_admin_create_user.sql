-- Update admin_create_user to support new fields
...
CREATE OR REPLACE FUNCTION admin_create_user(
  ...
  new_password TEXT,
  new_role TEXT,
  new_provider_name TEXT DEFAULT NULL,
  new_school_stage TEXT[] DEFAULT NULL,
...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    jsonb_build_object(
      ...
      'school_stage', coalesce(new_school_stage, '{}'::text[]),
      'subject', coalesce(new_subject, '{}'::text[]),
      'email_verified', true,
  ...
  INSERT INTO public.profiles (
    ...
    true,
    new_provider_name,
    coalesce(new_school_stage, '{}'::text[]),
    coalesce(new_subject, '{}'::text[])
  )
